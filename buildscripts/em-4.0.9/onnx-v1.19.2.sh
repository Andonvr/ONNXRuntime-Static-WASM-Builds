...
# The version of eigen included in onnxruntime 1.21.0 has a known issue with emscripten 4.0.3, so we need to update it to a newer commit that includes the fix.
perl -pi -e 's#^eigen;.*#eigen;https://github.com/eigen-mirror/eigen/archive/1d8b82b0740839c0de7f1242a3585e3390ff5f33/eigen-1d8b82b0740839c0de7f1242a3585e3390ff5f33.zip\;05b19b49e6fbb91246be711d801160528c135e34#' onnxruntime/cmake/deps.txt
